    ...
    public class LightGenerator : MonoBehaviour
    {
        ...
        public void Generate()
        {
            for (int i = 0; i < CountX; ++i)
            {
                ...
                {
                    var gao = new GameObject("Light_" + i + "_" + j, typeof(Light), typeof(VolumetricLightBeam), typeof(Rotater));
                    ...
                    var volumetricLightBeam = gao.GetComponent<VolumetricLightBeam>();
                    volumetricLightBeam.coneRadiusStart = Random.Range(0f, 0.1f);
                    volumetricLightBeam.geomSides = Random.Range(12, 36);
                    volumetricLightBeam.fresnelPow = Random.Range(1, 7.5f);
                    volumetricLightBeam.noiseEnabled = NoiseEnabled;
